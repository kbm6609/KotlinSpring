...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest() {
        ...
        val saveUser = userRepository.save(User("구병민", null))
        val request = BookLoanRequest("구병민", "이상한 나라의 엘리스")
        //when
    ...
    fun returnBookTest(){
        ...
        val saveUser = userRepository.save(User("구병민", null))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(saveUser, "이상한 나라의 엘리스",))
        val request = BookReturnRequest("구병민","이상한 나라의 엘리스")
        //when
